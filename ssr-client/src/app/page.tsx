...
export const metadata: Metadata = {
  ...
  description:
    'Купите вакуумные упаковщики высокого качества для хранения продуктов. Большой выбор и доступные цены.',
  keywords: [
...
const Catalog = async () => {
  ...
  const newsProductData = await axios.get(
    'http://localhost:5000/api/product/news',
  );
  return (
    <section className={styles.sectionCatalog}>
      <h2 className={styles.catalogTitle}>Каталог</h2>
      <h3 className={styles.catalogSubTitle}>
        Просмотрите весь интиресуеший вас товар
      </h3>
  ...
  return (
    <section className={styles.promotion}>
      ...
      <div className={styles.promotionImage}>
        ...
        <Image
          src={
            '/uploads/promo-pictures/' + data?.image ||
            '/uploads/promo-pictures/zagluska.webp'
          }
          width={397}
          height={397}
